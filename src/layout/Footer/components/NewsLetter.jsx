  ...
  return (
    <>
      ...
      <div className="absolute bg-black top-[-20%] left-[50%] px-[15px] py-4  translate-x-[-50%] h-[300px] w-9/10 rounded-2xl flex flex-col items-center justify-center md:flex-row sm:py-[0px] md:px-[5%] max-w-[77.5rem]">
        ...
        <form action="" className="flex flex-col justify-around w-full gap-[10%] h-4/10 ">
          {/* newsletter */}
          <div className="relative w-full border-none rounded-full focus:border-none focus:outline-none">
            <input
              ...
              className="relative w-full px-4 py-3 text-base font-semibold  bg-white border-none rounded-full cursor-pointer font-secondary text-black/80 h1/2 focus:border-none focus:outline-none pl-15  placeholder-black/40  text-indent-[20px]"
            />
            <Image
          ...
          <button className="w-full px-4 py-3 text-sm text-black bg-white rounded-full hover:bg-gray-200 cursor-pointer">
